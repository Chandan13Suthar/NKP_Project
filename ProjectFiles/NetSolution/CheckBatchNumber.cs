...
public class CheckBatchNumber : BaseNetLogic
{
    ...
    */
    ...
    {
        Project.Current.GetVariable("Model/BatchData/BatchStartTime").Value = DateTime.Now;
        Project.Current.GetVariable("Model/BatchData/BatchStopTime").Value = DateTime.Now;
        Project.Current.GetVariable("Model/BatchData/BatchRunning").Value = true;
    }
    ...
    private void ShowMessage(string message)
	{
        ...
        Label BatchMsg = Project.Current.Get<Label>("UI/Report_Screen/_33_Batch_Data/Backgroung/Rectangle1/MessageText");
	...
	private void DelayedAction(DelayedTask task)
	{
        ...
        //BatchMsg.Text = "";
        //BatchMsg.Visible = false;
        Label BatchMsg = Project.Current.Get<Label>("UI/Report_Screen/_33_Batch_Report/Backgroung/Rectangle1/MessageText");
        BatchMsg.Text = "";
        BatchMsg.Visible = false;
		delayedTask?.Dispose();
	}
